...
if __name__ == "__main__":
    ...
    # Test the key recovery attack using right plaintext structures
    test_attack(100, structure_size, dis_nr, dis_diff, net_path, selected_bits, direct_kg_bits_per_round, borrow_kg_bits_stage1, borrow_kg_bits_per_round_stage2, borrow_pos_per_round, m_per_round, c, attack_saved_folder)

    # Test the key recovery attack using wrong plaintext structures
    test_attack_with_bad_structure(100, structure_size, dis_nr, dis_diff, net_path, selected_bits, direct_kg_bits_per_round, borrow_kg_bits_stage1, borrow_kg_bits_per_round_stage2, borrow_pos_per_round, m_per_round, c, attack_saved_folder+"bad_structure/")