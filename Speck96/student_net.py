...
def make_resnet(num_blocks=2, num_filters=48, num_outputs=1, d1=64, d2=64, word_size=48, ks=5, depth=5, reg_param=0.0001, final_activation='sigmoid'):
...
def extract_sensitive_bits(raw_x, bits=[20,19,18,17,16,15,14,13,12,11,10,9,8]):
...
def train_speck_distinguisher(num_epochs, num_rounds=7, depth=1, diff=(0x80, 0x0), bits=[11,10,9,8], folder='./'):
