...
from util import cal_hw, extract_sensitive_bits
...
# Core attack process
# The filtering process ueses a nerual network as a distingusiher
...
def guess_last_round_sk_and_filter(ciphertext_structure, net, selected_bits, kg_low, m, key_guess_bits, c):
    ...
    for i in range(2**m):
        ...
        X = sp.convert_to_binary([x0, valid_y0, x1, valid_y1])
...
def key_recovery_attack_with_NBs(n, net_path, dis_nr, dis_diff, selected_bits, plain_diff, NBs, max_num_plaintext_structure, pre_nr, kg_low, m, key_guess_bits, c, attack_saved_folder='./'):
    ...
    for attack_index in range(n):
        ...
        while num_used_structures < max_num_plaintext_structure:
            ...
            surviving_kgs_scores_list = guess_last_round_sk_and_filter((c0l, c0r, c1l, c1r), net, selected_bits, kg_low, m, key_guess_bits, c)
...
if __name__ == '__main__':
    ...
    net_path = 'saved_model/7/12-11-4-3-1-0_62_student_distinguisher.h5'
    ...
    key_recovery_attack_with_NBs(1000, net_path, dis_nr, dis_diff, selected_bits, plain_diff, NBs, max_num_plaintext_structure, pre_nr, kg_low, m, key_guess_bits, c, attack_saved_folder)